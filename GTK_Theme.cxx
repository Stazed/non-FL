...
init_theme ( void )
{
    Fl::set_boxtype(  FL_UP_BOX,         gtk_up_box,           DX,DX,DX*2,DX*2 );
    Fl::set_boxtype(  FL_DOWN_BOX,       gtk_down_box,         DX,DX,DX*2,DX*2 );
    Fl::set_boxtype(  FL_THIN_UP_BOX,    gtk_thin_up_box,      DX,DX,DX*2,DX*2  );
    Fl::set_boxtype(  FL_THIN_DOWN_BOX,  gtk_thin_down_box,    DX,DX,DX*2,DX*2  );
    Fl::set_boxtype(  FL_UP_FRAME,       gtk_up_frame,         DX,DX,DX*2,DX*2  );
    Fl::set_boxtype(  FL_DOWN_FRAME,     gtk_down_frame,       DX,DX,DX*2,DX*2  );
    Fl::set_boxtype(  FL_THIN_UP_FRAME,  gtk_thin_up_frame,    DX,DX,DX*2,DX*2  );
    Fl::set_boxtype(  FL_THIN_DOWN_FRAME,gtk_thin_down_frame,  DX,DX,DX*2,DX*2  );
    Fl::set_boxtype(  FL_ROUND_UP_BOX,   gtk_round_up_box,     DX,DX,DX*2,DX*2  );
    Fl::set_boxtype(  FL_ROUND_DOWN_BOX, gtk_round_down_box,   DX,DX,DX*2,DX*2  );
}

void
init_gtk_theme ( void )
{
    Fl_Theme *t = new Fl_Theme( "GTK", "", "", init_theme );
